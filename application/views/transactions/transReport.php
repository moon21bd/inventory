 ...
 * @author Ameer <rhmoon21@gmail.com>
 * @date 06-Apr-2017
 */
?>
<!DOCTYPE HTML>
...
<div class="container margin-top-5">
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            <h4>Transactions Between <?= date('jS M, Y', strtotime($from)) ?>
                and <?= date('jS M, Y', strtotime($to)) ?></h4>
        </div>
    </div>
        ...
        <div class="col-xs-12 table-responsive">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading text-center">
                    Transactions Between <?= date('jS M, Y', strtotime($from)) ?>
                    and <?= date('jS M, Y', strtotime($to)) ?>
                </div>
