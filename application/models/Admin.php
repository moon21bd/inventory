...
class Admin extends CI_Model
{
    ...
    */
    ...
    public function getAll($orderBy = "first_name", $orderFormat = "ASC", $start = 0, $limit = "")
    {
        ...
        $this->db->where("email != ", "demo@inc.xyz");//added to prevent people from removing the demo admin account
    ...
    */
    ...
    {
        $this->db->where('id', $admin_id);
        $this->db->update($this->_table, ['account_status' => $new_status]);
    ...
    {
        $this->db->where('id', $admin_id);
        $this->db->update($this->_table, ['deleted' => $new_value]);
    ...
    */
    ...
    {
        $q = "SELECT * FROM $this->_table WHERE 
