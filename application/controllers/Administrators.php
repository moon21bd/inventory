...
class Administrators extends CI_Controller
{
  ...
  public function add()
  {
    ...
    $this->form_validation->set_rules(
      'email',
      'E-mail',
      ['trim', 'required', 'valid_email', 'is_unique[admin_users.email]', 'strtolower'],
    ...
    $this->form_validation->set_rules(
      'mobile1',
      'Phone number',
      ['required', 'trim', 'numeric', 'max_length[15]', 'min_length[11]', 'is_unique[admin_users.mobile1]'],
  ...
  public function suspend()
  {
    ...
    $new_status = $this->genmod->gettablecol('admin_users', 'account_status', 'id', $admin_id) == 1 ? 0 : 1;
  ...
  public function delete()
  {
    ...
    $admin_id = $this->input->post('_aId');
    $new_value = $this->genmod->gettablecol('admin_users', 'deleted', 'id', $admin_id) == 1 ? 0 : 1;
  ...
  public function crosscheckMobile($mobile_number, $admin_id)
  {
    ...
    $adminWithNum = $this->genmod->getTableCol('admin_users', 'id', 'mobile1', $mobile_number);
  ...
  public function crosscheckEmail($email, $admin_id)
  {
    ...
    $adminWithEmail = $this->genmod->getTableCol('admin_users', 'id', 'email', $email);
