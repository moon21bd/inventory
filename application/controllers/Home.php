...
class Home extends CI_Controller
{
  ...
  public function login()
  {
    ...
    if ($this->form_validation->run() !== FALSE) {
      ...
      $passwordInDb = $this->genmod->getTableCol('admin_users', 'password', 'email', $givenEmail);
      $account_status = $this->genmod->getTableCol('admin_users', 'account_status', 'email', $givenEmail);
      $deleted = $this->genmod->getTableCol('admin_users', 'deleted', 'email', $givenEmail);
