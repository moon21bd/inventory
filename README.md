...
- If you edit the folder name, you will need to do the following:
  - Open __.htaccess in the root folder__ and change the line with __"inventory"__ to your new folder (project) name. Leave it blank if app is directly inside your __www__ or __html__ directory.
